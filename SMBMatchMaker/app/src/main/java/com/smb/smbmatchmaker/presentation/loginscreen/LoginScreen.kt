...
package com.smb.smbmatchmaker.presentation.loginscreen
...
import com.smb.smbmatchmaker.presentation.companyscreen.CompanyDetailsActivity
...
fun checkCredentials(creds: Credentials, context: Context): Boolean {
    if (creds.isNotEmpty() && creds.login == "admin") {
        context.startActivity(Intent(context, CompanyDetailsActivity::class.java))
...
fun LoginFormPreviewDark() {
    CryptocurrencyAppYTTheme(darkTheme = true) {
        LoginScreen()
    }
}*/
